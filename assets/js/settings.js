...
function confirmPassword(){
  showDialog({ title:'Xác nhận đổi mật khẩu', msg:'Chúng tôi sẽ gửi một liên kết đặt lại mật khẩu đến email đã đăng ký của bạn. Bạn có chắc chắn muốn tiếp tục?', okText:'Xác nhận', onConfirm:function(){ location.href='password-sent.html'; } });
}
